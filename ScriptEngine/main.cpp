...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	if (success)
	{
		...
		cout << (scriptEngine.call<int, int, int>(hndlI, 40, 2) == 42) << endl;
		cout << (scriptEngine.call<float, float, float>(hndlF, 2.14015f, 1.00144f) == 2.14015f + 1.00144f) << endl;
		cout << (scriptEngine.call<float, int, float>(hndlCast, 2, 0.71828f) == 2.f + 0.71828f) << endl;
